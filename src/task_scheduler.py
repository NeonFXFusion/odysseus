...
HOUSEKEEPING_DEFAULTS = {
    ...
    "check_instagram_urgency": {"name": "Instagram Tags",          "schedule": "cron",  "scheduled_time": None,    "cron_expression": "0 * * * *", "ship_paused": True, "legacy_names": ["Instagram Triage", "Urgent Instagram"]},
